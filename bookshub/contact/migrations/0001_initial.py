...
class Migration(SchemaMigration):
    ...
    models = {
        u'contact.message': {
            'Meta': {'ordering': "('-modified_at', '-created_at')", 'object_name': 'Message'},
        ...
        u'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'1c88690c-8109-4595-84dc-03847baff65a'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
