...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'books_book', 'image', self.gf('django_filepicker.models.FPFileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Book.image'
        db.alter_column(u'books_book', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'2a00b81e-5abe-40bc-ab83-b1e480cca586'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
