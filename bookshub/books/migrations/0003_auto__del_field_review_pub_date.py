...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Review.pub_date'
        db.delete_column(u'books_review', 'pub_date')


    def backwards(self, orm):
        # Adding field 'Review.pub_date'
        db.add_column(u'books_review', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 24, 0, 0), blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'c9feda2f-740a-4e91-bc63-dab43fac6c2a'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
