...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderItem.seller_has_confirmed'
        db.add_column(u'cart_orderitem', 'seller_has_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.seller_has_confirmed'
        db.delete_column(u'cart_orderitem', 'seller_has_confirmed')
    ...
    models = {
        ...
        u'cart.orderitem': {
            ...
            'seller_has_confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'04c6cba1-f436-4f26-b9ff-29ec0b3f16b4'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
